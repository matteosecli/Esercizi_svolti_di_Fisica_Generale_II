...
\begin{problema}
	...
	Calcolare il campo elettrico lungo l'asse $z$ passante per il cento della 
...
\begin{proof}
	...
	(si veda esercizio I.22 [Mencuccini], pag. 72: le formule utilizzate in seguito 
	sono state ricavate facendo tendere ad infinito la lunghezza del filo) la 
	componente $z$ (componente $y$ sull'esercizio del [Mencuccini] moltiplicata 
	per $\cos \vartheta$) è:
	$$
	\vec{E_z}=
