...
\begin{proof}
	\begin{enumerate}
		...
		$dq$. Non abbiamo necessità di considerare ``potenziali infinitesimi'' perché, 
		per le proprietà dei conduttori, il potenziale è costante su tutta la superficie.
		...
		Giusto per completezza, si può generalizzare l'equazione (\ref{eq:green_discrete})
		a due distribuzioni di carica qualsiasi (vedi anche Problema 3.50 \cite{griffiths}).
