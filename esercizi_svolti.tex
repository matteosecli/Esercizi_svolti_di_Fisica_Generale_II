	...
	\begin{enumerate}
		...
		\begin{figure}[H]
			...
			\begin{asy}[height=6cm,inline=true,attach=false,viewportwidth=\linewidth]
				...
				zaxis3(Label("\small $z$",position=EndPoint,align=NW),
				zmin, zmax, arrow=EndArrow3, NoTicks3);
				label("\small $a$",(0,2,0),SE);
				label("\small $-a$",(0,-2,0),SW);
				draw((0,-2,-2)--(0,-2,4),linewidth(1bp));
				draw((0,2,-2.5)--(0,2,3.5),linewidth(1bp));
				path3 left_side_p = (0,-2,-2)--(0,-2,4)--(0,0,3.75)--(0,0,-2.25)--cycle;
				path3 right_side_p = (0,2,-2.5)--(0,2,3.5)--(0,0,3.75)--(0,0,-2.25)--cycle;
				surface left_side=surface(left_side_p);
				surface right_side=surface(right_side_p);
				draw(left_side,heavyblue+opacity(0.4));
				draw(right_side,heavyred+opacity(0.4));
				draw(Label("\small $\vec{j}$"),
				(0,-1,0)--(0,-1,2),arrow=Arrow3(16bp,8),1bp+blue);
				draw(Label("\small $\vec{-j}$"),
				(0,1,2)--(0,1,0),arrow=Arrow3(16bp,8),1bp+red);
			\end{asy}
			\caption{Piattina con correnti in direzioni opposte.}
			\label{fig:piattina_caso_a}
		\end{figure}
		\item La densità di corrente:
		\begin{equation}
		...
		\begin{figure}[H]
			...
			\begin{asy}[height=6cm,inline=true,attach=false,viewportwidth=\linewidth]
				...
				draw((0,-2,-2)--(0,-2,4),linewidth(1bp));
				draw((0,2,-2.5)--(0,2,3.5),linewidth(1bp));
				path3 surface_p = (0,-2,-2)--(0,-2,4)--(0,2,3.5)--(0,2,-2.5)--cycle;
				surface surface=surface(surface_p);
				draw(surface,heavyblue +opacity(0.4));
				draw(Label("\small $\vec{j}$"),
				(0,0,0)--(0,0,2),arrow=Arrow3(16bp,8),1bp+blue);
			\end{asy}
			\caption{Piattina con corrente in un'unica direzione.}
			\label{fig:piattina_caso_b}
		\end{figure}
	\end{enumerate}
\end{problema}
\begin{proof}
	\begin{enumerate}
		...
		\end{align*}
		Facendo riferimento alla Figura \ref{fig:piattina_caso_a}, 
		sia $l_{1} = y$ la distanza 
...
\begin{problema}%%%%% Problema 59
	Il solenoide a forma toroidale con sezione quadrata mostrato 
	in Figura \ref{fig:toro_quadrato} consiste 
	in un nucleo di permeabilità $\mu$ attorno a cui sono 
	avvolte $N$ spire; sia $R_1$ il raggio interno del toro, 
	$R_2$ quello esterno e $h$ l'altezza della sezione. 
	Il materiale del nucleo è lineare. 
	...
	\begin{figure}[H]
		\centering
		\begin{asy}[height=7cm,inline=true,attach=false,viewportwidth=\linewidth]
			import three;
			import graph3;
			import solids;
			texpreamble("\let\oldhat\hat
			...
			zaxis3(Label("\small $z$",position=EndPoint,align=NW),
			zmin, zmax, arrow=EndArrow3, NoTicks3);
			revolution torus=revolution((3,0,1)--(1,0,1)--(1,0,-1)--(3,0,-1)--cycle,Z,0,360);
			surface s=surface(torus);
			draw(s,nu=8,nv=-1,meshpen=2bp+red,palegrey);
		\end{asy}
		\caption{Avvolgimento toroidale a sezione quadrata.}
		\label{fig:toro_quadrato}
	\end{figure}
\end{problema}
\begin{proof}
...
\begin{problema}%%%%% Problema 60
	...
	Il toroide ha raggio medio $R_{0}$, 
	differenza fra i raggi $b$, altezza $h$ ed 
	è costituito da $N$ spire.
