...
\begin{problema}
	Il dielettrico del condensatore in figura (FIGURA) non è perfetto: esso presenta una
	conducibilità non nulla. Detta $\varepsilon$ la permeabilità dielettrica e $\rho_e$ la
	resistività del dielettrico, si dimostri la seguente relazione:
	\begin{equation}
