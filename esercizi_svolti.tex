...
\begin{proof}
	\begin{enumerate}
		\item Per ragioni di simmetria, sappiamo che fra i due cilindri il campo elettrico
		 ...
		 = -\frac{\lambda}{2\pi\varepsilon_0}\left.\log(r)\right\rvert_{a}^{b}
		 =-\frac{\lambda}{2\pi\varepsilon_0}\log\left(\frac{b}{a}\right).
		 $$
		 Quindi
		 $$
		 \boxed{
		 V_A - V_B = \frac{\lambda}{2\pi\varepsilon_0}\log\left(\frac{b}{a}\right)
		 }
		 $$
	\end{enumerate}
\end{proof}
